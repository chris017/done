...
const ToDoList1 = () => {
  ...
  const todosToday = data.filter(todo => todo.type === "today" + user.name);
      ...
      <div class="form-container">
        <form name="todoForm" onSubmit={handleSubmit(onSubmit)}>
          <div class="list-group toDo">
            ...
            {todosToday && todosToday.map(todosToday => <label class="list-group-item d-flex gap-3">
